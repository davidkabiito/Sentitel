...
def get_y_true(task_name):
    ...
    Both tasks of sentitel use the test set of task-BERT-pair-NLI-M to get true labels.
 
    """
    if task_name in ["sentitel_single", "sentitel_NLI_M"]:
        true_data_file = "data/sentitel/bert-pair/test_NLI_M.tsv"
...
def main():
    ...
    parser.add_argument("--task_name",
                        ...
                        type=str,
                        required=True,
                        choices=["sentitel_single", "sentitel_NLI_M"],
    ...
    if args.task_name in ["sentitel_single", "sentitel_NLI_M"]:
