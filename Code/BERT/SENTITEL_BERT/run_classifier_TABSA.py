...
from processor import (Sentitel_QA_M_Processor, Sentitel_single_Processor)
...
def main():
    ...
    # prepare dataloaders
    processors = {
        "sentitel_single":Sentitel_single_Processor,
        "sentitel_NLI_M":Sentitel_NLI_M_Processor,
    }
